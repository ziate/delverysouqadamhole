...
class OrderDetailsScreen extends StatelessWidget {
  ...
  final int index;
  const OrderDetailsScreen({Key key, this.orderModel, @required this.index})
      : super(key: key);
                          ...
                          Container(
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                      '${'order_note'.tr} : ${orderModel.orderNote != null ? orderModel.orderNote ?? '' : ""}',
                                      style: rubikRegular),
                                  const SizedBox(
                                      height: Dimensions.paddingSizeDefault),
                                  Text(
                                      '${'address'.tr} : ${orderModel.shippingAddressData != null ? orderModel.shippingAddress.address : orderModel.shippingAddress ?? ''}',
                                      style: rubikRegular),
                                  const SizedBox(
                                      height: Dimensions.paddingSizeDefault),
                                  Text(
                                      '${'billing_address'.tr} : ${orderModel.billingAddress != null ? jsonDecode(orderModel.billingAddress)['address'] : orderModel.billingAddress ?? ''}',
                                      style: rubikRegular),
                                ]),
                          ),
                          const SizedBox(height: 20),
                            ...
                            children: [
                              ...
                              orderModel.orderStatus == 'processing' ||
                                  ...
                                  ? Row(children: [
                                      ...
                                      Text(orderModel.paymentStatus.tr,
                                          style: rubikMedium.copyWith(
                                              color: Theme.of(context)
                                                  .primaryColor)),
                                    ])
                                      ...
                                      SizedBox(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: FadeInImage.assetNetwork(
                                            ...
                                            placeholder: Images.placeholder,
                                            image:
                                                '${Get.find<SplashController>().baseUrls.productThumbnailUrl}/${orderController.orderDetails[index].productDetails.thumbnail}',
                                            height: 70,
                                            width: 70,
                                            fit: BoxFit.cover,
                                          ),
