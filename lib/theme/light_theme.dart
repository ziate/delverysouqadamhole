...
ThemeData light = ThemeData(
  ...
  scaffoldBackgroundColor: const Color(0xFFE88F21),
  hintColor: Colors.grey,
  primaryColorLight: const Color(0xFFE88F21),
  canvasColor: const Color(0xFFE88F21),
  ...
  primaryColor: const Color(0xFFE88F21), // for primary color
